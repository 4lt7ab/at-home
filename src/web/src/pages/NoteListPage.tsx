...
import {
  ...
  Input, Textarea, ModalShell, Field, PageHeader,
} from "@4lt7ab/ui/ui";
    ...
    <ModalShell onClose={onClose}>
      <form onSubmit={handleSubmit}>
        ...
        <Stack gap="sm">
          ...
          <Field label="Context" htmlFor="note-context">
            <Textarea id="note-context" rows={4} placeholder="Context (optional)" value={context} onChange={(e) => setContext(e.target.value)} />
          </Field>
        </Stack>
